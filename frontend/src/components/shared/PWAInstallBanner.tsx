    ...
    <>
      <AnimatePresence>
        {showBanner && deferredPrompt && (
          ...
          >
            <div className="bg-surface-900 dark:bg-surface-950 text-white rounded-t-3xl md:rounded-3xl p-5 shadow-card-hover dark:shadow-card-hover-dark">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-surface-400 dark:text-surface-500 text-sm mt-0.5 leading-snug">
              ...
              <div className="flex gap-3 mt-4">
                <button
                  onClick={handleDismiss}
                  className="flex-1 py-2.5 rounded-xl border border-surface-700 dark:border-surface-600 text-surface-400 dark:text-surface-500 text-sm font-medium hover:border-surface-600 dark:hover:border-surface-500 transition-colors"
                >
                  Ahora no
                </button>
                <button
      ...
      <AnimatePresence>
        {showIOSGuide && (
          <motion.div
            ...
            style={{ paddingBottom: "var(--safe-bottom)" }}
          >
            <div className="bg-surface-900 dark:bg-surface-950 text-white rounded-t-3xl p-5 shadow-card-hover dark:shadow-card-hover-dark">
              ...
              <div className="space-y-3">
                {[
                  ...
                  { step: "2", text: '"Agregar a pantalla de inicio"', icon: "plus" },
                  { step: "3", text: 'Toca "Agregar" para confirmar', icon: "check" },
                ].map(({ step, text, icon }) => (
                  <div key={step} className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-surface-300 dark:text-surface-400">{icon} {text}</span>
                  </div>
                ))}
              </div>
              <div className="text-center mt-4 text-surface-400 dark:text-surface-500 text-xs">
